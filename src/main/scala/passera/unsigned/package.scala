...
package object unsigned {
  ...
  trait UByteIsIntegral extends Integral[UByte] {
    ...
    def parseString(str: String): Option[UByte] = Try(str.toInt.toUByte).toOption
  }
  ...
  trait UShortIsIntegral extends Integral[UShort] {
    ...
    def parseString(str: String): Option[UShort] = Try(str.toInt.toUShort).toOption
  }
  ...
  trait UIntIsIntegral extends Integral[UInt] {
    ...
    def parseString(str: String): Option[UInt] = Try(str.toLong.toUInt).toOption
  }
  ...
  trait ULongIsIntegral extends Integral[ULong] {
    ...
    def parseString(str: String): Option[ULong] = Try(str.toLong.toULong).toOption
  }
